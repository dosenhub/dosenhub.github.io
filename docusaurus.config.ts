...
const config: Config = {
  title: 'DosenHub',
  tagline: 'Pusat Dokumentasi Modul Perkuliahan',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/dosenhub/dosenhub.github.io/tree/main/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {to: '/docs/contributors/intro', label: 'Contributors', position: 'left'},
        {
          type: 'localeDropdown',
          position: 'right',
        },
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub',
              href: 'https://github.com/dosenhub',
            },
          ],
        },
      ],
